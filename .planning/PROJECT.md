...
- [x] Google Business Profile services audit + alignment with the website menu (GBP-01..04). *Validated in Phase 3: `03-GBP-ALIGNMENT.md` paste-ready deliverable — current GBP state, gap table vs the 8 `SERVICES`, 8 spam-clean GBP entries (no phone/URL), and the deliberate no-code-change decisions. Off-site dashboard publishing is owner action.*

### Active

<!-- Current scope. Building toward these. -->

- *(none — all v1.0 milestone requirements validated)*
...
| GBP alignment is documentation-only — no `config.ts` renames, primary-only category, untouched review count | Descriptive GBP names belong in the GBP dashboard, not the site menu; the live review count is auto-pulled at build; no strong second category fits | Applied in Phase 3 — `config.ts` left as-is (Trim Beard / Hot Shave); 8 paste-ready GBP entries delivered for the owner to publish |

---
*Last updated: 2026-06-27 — Phase 3 complete (GBP services alignment deliverable shipped & verified; v1.0 milestone requirements all validated)*
