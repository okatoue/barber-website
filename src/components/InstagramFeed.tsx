...
export default function InstagramFeed() {
  // Placeholder grid — replace with an Instagram widget (e.g., Elfsight, Behold, or SnapWidget)
  // To integrate: replace the placeholder grid below with the widget embed code
  const placeholders = Array.from({ length: 6 }, (_, i) => i + 1);

  return (
    <section className="section">
      <h2 className="section-heading">Fresh Cuts</h2>
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 gap-3 md:gap-4 max-w-4xl mx-auto">
        {placeholders.map((i) => (
          <a
            ...
            className="aspect-square bg-surface rounded-lg overflow-hidden group relative"
          >
